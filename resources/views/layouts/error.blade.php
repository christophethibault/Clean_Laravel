...
<head>
	...
	<style>
		...
		.secondary-text-color {
			color: rgba(45, 57, 224, 1) !important;
		}
		...
		.border-button {
			color: rgba(28, 13, 13, 1) !important;
			border-color: rgba(28, 13, 13, 1) !important;
		}

		.button {
			background-color: rgba(28, 13, 13, 1) !important;
...
<div class="content-container">
	...
	@section('content')
		...
		<div class="subheader primary-text-color">
			Hum, vous n'êtes pas autorisé a consulter cette page...
		</div>
		<hr>
		...
		<div class="context primary-text-color">
			...
			<p>
				...
				{{--Si vous pensez que qu'il y a un problème--}}
				{{--If you think something is broken, report a problem.--}}
			</p>
		</div>
		<div class="buttons-container">
			<a class="border-button" href="/">Revenir a l'accueil</a>
			{{--<a class="border-button" href="mailto:test" target="_blank">Report A Problem</a>--}}
		</div>
	@show
